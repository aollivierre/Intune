...
$logFileName = "Reset_Intune_Enrollment_$(Get-Date -Format 'yyyyMMdd_HHmmss').log"
...
function Install-RequiredModules {
    ...
    # Install Microsoft.Graph.Intune module if not installed
...
# function DoutSourceExecuteDeployApplication {
#     # Get the script directory
    
#     # Construct the path to the target script
#     $targetScriptPath = Join-Path $scriptRoot "Execute-DeployApplication.ps1"
...
#     }
#     else {
#         Write-Error "Target script not found at path: $targetScriptPath"
#     }
# }

# DoutSourceExecuteDeployApplication

# Execute-DeployApplication


$scriptPath2 = Split-Path -Parent $MyInvocation.MyCommand.Definition
function Execute-DeployApplication {
    ...
    $deployApplicationPath = Join-Path -Path "$scriptPath2\Install-OneTrace\PSAppDeployToolkit_v3.9.2\Toolkit" -ChildPath "Deploy-Application.ps1"
    ...
    # Log start time
    $startTime = Get-Date
    Write-Host "[$startTime] Starting Deploy-Application.ps1" -ForegroundColor $infoColor
