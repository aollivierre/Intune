...
$005_TeamViewerToolkitURL = $null
$006_AzDevOpsToken = $null



$005_TeamViewerToolkitURL = "https://dev.azure.com/CanadaComputingInc/edb7565a-620a-4960-89ae-96e7765b9202/_apis/git/repositories/4e3325c7-0dba-4f5c-9c3f-0e6b96208c22/items?scopePath=/Preview/Install-TeamViewer/PSAppDeployToolkit_v3.8.4/Toolkit.zip&download=true&api-version=6.1-preview.1"
$006_AzDevOpsToken = "d36lhpn4wyfrvswmqfms5dbawrizdh5uqgxrmbi5h3shajii5yfa"
$007_toolkitzipFilePassword = "welcome123"


$005_TeamViewerToolkitURL = ConvertTo-SecureString "$005_TeamViewerToolkitURL" -AsPlainText -Force
$006_AzDevOpsToken = ConvertTo-SecureString "$006_AzDevOpsToken" -AsPlainText -Force
$007_toolkitzipFilePassword = ConvertTo-SecureString "$007_toolkitzipFilePassword" -AsPlainText -Force


$005_TeamViewerToolkitURL_Tags = @{ 'Secret Description' = 'This is the URL for Az DevOps'; 'IT' = 'true'}
$006_AzDevOpsToken_Tags = @{ 'Secret Description' = 'This is a token for Az DevOps'; 'IT' = 'true'}
$007_toolkitzipFilePassword_Tags = @{ 'Secret Description' = 'This is the password for the zipped toolkit downloaded from Az DevOPS'; 'IT' = 'true'}

$005_TeamViewerToolkitURL = Set-AzKeyVaultSecret -VaultName "$AzKeyVault_Name_1" -Name "005-TeamViewerToolkitURL" -SecretValue $005_TeamViewerToolkitURL -Tags $005_TeamViewerToolkitURL_Tags


$006_AzDevOpsToken = Set-AzKeyVaultSecret -VaultName "$AzKeyVault_Name_1" -Name "006-AzDevOpsToken" -SecretValue $006_AzDevOpsToken -Tags $006_AzDevOpsToken_Tags



$007_toolkitzipFilePassword = Set-AzKeyVaultSecret -VaultName "$AzKeyVault_Name_1" -Name "007-toolkitzipFilePassword" -SecretValue $007_toolkitzipFilePassword -Tags $007_toolkitzipFilePassword_Tags
