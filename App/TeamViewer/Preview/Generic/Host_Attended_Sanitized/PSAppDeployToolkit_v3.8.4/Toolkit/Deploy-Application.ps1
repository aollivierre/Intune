...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		#Start Connecting to Azure in prep for Az Keyvault access
		Disconnect-AzAccount
		Connect-AzAccount


		#TeamViewer Parameters
		Write-host 'downloading tv settings' -ForegroundColor green
		...
		$003_TeamViewerCUSTOMCONFIGID = Get-AzKeyVaultSecret -VaultName "AKV001-TeamViewer" -Name "003-TeamViewerCUSTOMCONFIGID" -AsPlainText
		Write-host 'done getting secrets for Azure Key Vault' -ForegroundColor green
		...
		$CUSTOMCONFIG_ID_1 = $003_TeamViewerCUSTOMCONFIGID

		$API_TOKEN_1 = $null
		$API_TOKEN_1 = $002_TeamViewerAPITOKEN
		...
		Send-TeamViewerIDtoMSTeams -TeamViewerSecret $001_TeamViewerTeamsWebhook -TeamViewerID $TeamViewerID_1 -Deviceinfo $Deviceinfo_Object
