...
#if the zip file password is compromised then the cred manager can be compromised because the decryptor is included and can be tweaked to provde the secrets in plain text
...
function Send-TeamViewerIDtoMSTeams {
    ...
    process {
        ...
        try {
            ...
            $TeamsID = 'https://canadacomputing.webhook.office.com/webhookb2/55fe0bd5-5db4-4078-b922-005e7117f2ff@dc3227a4-53ba-48f1-b54b-89936cd5ca53/IncomingWebhook/120ed4936cb8422ca1ae604081f3fc0b/bf72cc2b-b88d-4570-afc6-dc785e5e5f80'
