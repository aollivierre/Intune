...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$SiteID1 = $null
		$SiteID1 = 'a4ebb808-023a-4469-bca2-da440e08adbc'


		$downloadDattoWin32AppSplat1 = @{
			Platform = $Platform1
			SiteID   = $SiteID1
		}
		Download-DattoWin32App @downloadDattoWin32AppSplat1
		...
		# If ($addPublisher) {
		Show-InstallationProgress -StatusMessage 'Installing Datto RMM Agent for CCI. This may take some time. Please wait...'
		Execute-Process -Path "$dirFiles\DRMMSetup.exe" -WindowStyle Hidden
		# }
		...
		# Show-InstallationProgress -StatusMessage 'Launching Datto RMM Agent for CCI. This may take some time. Please wait...'
	...
	ElseIf ($deploymentType -ieq 'Uninstall') {
		...
		Show-InstallationProgress -StatusMessage 'UnInstalling Datto RMM Agent for CCI. This may take some time. Please wait...'
