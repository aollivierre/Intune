...
function UploadAzureStorageChunk($sasUri, $id, $body){
	...
	try
	{
		$response = Invoke-WebRequest $uri -Method Put -Headers $headers -Body $encodedBody -UseBasicParsing:$true;
	}
	catch
	{
		Write-Host -ForegroundColor Red $request;
...
$SourceFile = "D:\Code\Intune\Intune\W32_App_Deployment\8-Upload-Win32App\Private\AgentSetup_FGC_Corporate.intunewin"
...
$DetectionRule = @($FileRule,$RegistryRule)
...
getting the following error:
    ...
    PUT https://mmcswda02.blob.core.windows.net/64c0de54-03d2-4272-9d85-76f25bc35d42/c8f57ac0-1b01-4975-a43c-833a267c2f86/6c0dbc6c-9adb-4c1d-92d1-dd0b759bc567.intunewin.bin?sv=2016-05-31&sr=b&si=1291213440&sig=%2FS8iWP6wgdgQvSe9X4VInGFSNZ3LegUUx66fzqKgQ8s%3D&comp=block&blockid=MDAwMA==
The response content cannot be parsed because the Internet Explorer engine is not available, or Internet Explorer's first-launch configuration is not complete. Specify the UseBasicParsing parameter and try again.

Aborting with exception: System.NotSupportedException: The response content cannot be parsed because the Internet Explorer engine is not available, or Internet Explorer's first-launch configuration is not complete. Specify the UseBasicParsing parameter and try again.
...
.NOTES
    ...
    PS D:\Code\Intune> . "d:\Code\Intune\Intune\W32_App_Deployment\8-Upload-Win32App\Public\Win32_Application_Add.ps1"
Testing if SourceFile 'D:\Code\Intune\Intune\W32_App_Deployment\8-Upload-Win32App\Private\AgentSetup_FGC_Corporate.intunewin' Path is valid...
    ...
    "detectionRules":  [
                           {
                               ...
                               "detectionValue":  null,
                               "fileOrFolderName":  "application.exe",
                               "check32BitOn64System":  "False"
                           },
                           {
                               "valueName":  "",
                               "@odata.type":  "#microsoft.graph.win32LobAppRegistryDetection",
                               "keyPath":  "HKEY_LOCAL_MACHINE\\SOFTWARE\\Program",
                               "detectionType":  "exists",
                               "operator":  "notConfigured",
                               "detectionValue":  "",
...
POST https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/314afad2-11cf-4127-b2f7-f9d19c852c0f/microsoft.graph.win32LobApp/contentVersions
{}

Getting Encryption Information for 'D:\Code\Intune\Intune\W32_App_Deployment\8-Upload-Win32App\Private\AgentSetup_FGC_Corporate.intunewin'...

Creating a new file entry in Azure for the upload...
POST https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/314afad2-11cf-4127-b2f7-f9d19c852c0f/microsoft.graph.win32LobApp/contentVersions/1/files
{
    "@odata.type":  "#microsoft.graph.mobileAppContentFile",
    "manifest":  null,
    "size":  10468257,
    "name":  "IntunePackage.intunewin",
    "sizeEncrypted":  10468320,
    "isDependency":  false
}

Waiting for the file entry URI to be created...
GET https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/314afad2-11cf-4127-b2f7-f9d19c852c0f/microsoft.graph.win32LobApp/contentVersions/1/files/d88331b8-a001-4389-b998-fc5fc44470d3
GET https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/314afad2-11cf-4127-b2f7-f9d19c852c0f/microsoft.graph.win32LobApp/contentVersions/1/files/d88331b8-a001-4389-b998-fc5fc44470d3

Uploading file to Azure Storage...
PUT https://mmcswda02.blob.core.windows.net/64c0de54-03d2-4272-9d85-76f25bc35d42/72494222-1e04-4c3d-96a7-92db2c82f8f7/d88331b8-a001-4389-b998-fc5fc44470d3.intunewin.bin?sv=2016-05-31&sr=b&si=757983739&sig=Q84U%2BeAFa8KlALsgIL16jHCbO222U3gInoxi6RVBphs%3D&comp=block&blockid=MDAwMA==
PUT https://mmcswda02.blob.core.windows.net/64c0de54-03d2-4272-9d85-76f25bc35d42/72494222-1e04-4c3d-96a7-92db2c82f8f7/d88331b8-a001-4389-b998-fc5fc44470d3.intunewin.bin?sv=2016-05-31&sr=b&si=757983739&sig=Q84U%2BeAFa8KlALsgIL16jHCbO222U3gInoxi6RVBphs%3D&comp=block&blockid=MDAwMQ==
PUT https://mmcswda02.blob.core.windows.net/64c0de54-03d2-4272-9d85-76f25bc35d42/72494222-1e04-4c3d-96a7-92db2c82f8f7/d88331b8-a001-4389-b998-fc5fc44470d3.intunewin.bin?sv=2016-05-31&sr=b&si=757983739&sig=Q84U%2BeAFa8KlALsgIL16jHCbO222U3gInoxi6RVBphs%3D&comp=blocklist
<?xml version="1.0" encoding="utf-8"?><BlockList><Latest>MDAwMA==</Latest><Latest>MDAwMQ==</Latest></BlockList>

Committing the file into Azure Storage...
POST https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/314afad2-11cf-4127-b2f7-f9d19c852c0f/microsoft.graph.win32LobApp/contentVersions/1/files/d88331b8-a001-4389-b998-fc5fc44470d3/commit
{
    "fileEncryptionInfo":  {
                               "fileDigestAlgorithm":  "SHA256",
                               "encryptionKey":  "hPhTZvY6EZwo6kpzhurcDM6X/7ueuDvS4XDwTRgAoo0=",
                               "initializationVector":  "0YEYUfH0411ipYQKPGr2Uw==",
                               "fileDigest":  "LqbmCUvJxHK0GyxUprbIMdzgCLdPT9cW0oiBq2QRiyw=",
                               "mac":  "va7g0L5OZGdL59xSnDZ5OUJQNgSY4YxntrJNkph4dKU=",
                               "profileIdentifier":  "ProfileVersion1",
                               "macKey":  "Coc4JnXu8WVVpdKxLIvGa1onUJMxMY3758i24lXKVxk="
                           }
}
...
Committing the file into Azure Storage...
PATCH https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/314afad2-11cf-4127-b2f7-f9d19c852c0f
{
    "@odata.type":  "#microsoft.graph.win32LobApp",
