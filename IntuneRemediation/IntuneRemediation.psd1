@{
    ...
    FunctionsToExport = @(
        ...
        'Protect-IntuneRemediationScript',
        'Confirm-IntuneCodeSigningChain',
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('Intune', 'Remediation', 'MDM', 'Token', 'CodeSigning')
            ...
            ReleaseNotes = 'Added token secret management capabilities and code signing functionality'
        }
    }
} 